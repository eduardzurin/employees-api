...
const employeesController = __importStar(require("../controllers/employees.controller"));
const employee_schema_1 = require("./schemas/employee.schema");
function getPosts(fastify) {
    return {
        method: "GET",
        url: "/api/employees/:id",
        schema: {
            params: employee_schema_1.employeeIdSchema,
        },
...
//# sourceMappingURL=get-employee.js.map